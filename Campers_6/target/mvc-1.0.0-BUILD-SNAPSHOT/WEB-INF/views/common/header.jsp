...
<!-- HYPER App css -->
<link href="${path}/resources/assets/css/icons.min.css" rel="stylesheet"
	type="text/css" />
...
<body style="padding-top: 72px;">
	<header class="header">
				...
				<nav class="navbar navbar-expand-lg fixed-top shadow navbar-light bg-white">
					...
					<div class="container-fluid">
						<div class="d-flex align-items-center">
							<a class="navbar-brand py-1" href="${path}"><img	src="${path}/resources/img/newphoto/camper_logo_text.png" alt="Campers logo"></a>
						</div>
						...
						<div class="collapse navbar-collapse" id="navbarCollapse">
							<ul class="navbar-nav ms-auto">
								<li class="nav-item dropdown"><a class="nav-link dropdown-toggle active TmoneyRoundWindExtraBold" id="homeDropdownMenuLink" href="index.html" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size: 1.2rem;">캠핑장</a>
									<div class="dropdown-menu" aria-labelledby="homeDropdownMenuLink">
										<a class="dropdown-item GmarketSansMedium"
											href="category-2-rooms.html">캠핑</a> <a
											class="dropdown-item GmarketSansMedium"
											href="category-2-rooms.html">오토캠핑</a> <a
											class="dropdown-item GmarketSansMedium"
											href="category-2-rooms.html">글램핑</a> <a
											class="dropdown-item GmarketSansMedium"
								...
								<li class="nav-item ps-2"><a
									...
									href="product_index.html" style="font-size: 1.2rem;">캠핑용품커머스</a>
								</li>
								<li class="nav-item dropdown ps-2"><a
									...
									<div class="dropdown-menu dropdown-menu-end"
										...
										<a class="dropdown-item GmarketSansMedium" href="blog.html">후기 게시판</a> 
										<a class="dropdown-item GmarketSansMedium" href="${path}/boards/freeList">자유 게시판</a>
								...
								<a class="nav-link TmoneyRoundWindExtraBold" href="login.html" style="font-size: 1.2rem;">로그인</a></li>
								<li class="nav-item ps-2">
								<a class="nav-link TmoneyRoundWindExtraBold" href="${path}/user/enroll" style="font-size: 1.2rem;">회원가입</a></li>
							</ul>
						</div>
					</div>
				</nav>
		...
		<nav class="navbar navbar-expand-lg fixed-top shadow navbar-light bg-white">
			<div class="container-fluid">
				<div class="d-flex align-items-center">
					<a class="navbar-brand py-1" href="index.html"><img	src="${path}/resources/img/newphoto/camper_logo_text.png" alt="Campers logo"></a>
				</div>
				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					...
					<ul class="navbar-nav ms-auto">
						...
						<li class="nav-item dropdown ps-2"><a class="nav-link dropdown-toggle TmoneyRoundWindExtraBold" id="docsDropdownMenuLink" href="index.html" data-bs-toggle="dropdown" aria-haspopup="true"
							aria-expanded="false" style="font-size: 1.2rem;">게시판</a>
							<div class="dropdown-menu dropdown-menu-end"
								aria-labelledby="docsDropdownMenuLink">
								<h6 class="dropdown-header fw-normal GmarketSansMedium">게시판</h6>
								<a class="dropdown-item GmarketSansMedium" href="blog.html">후기
									게시판</a> <a class="dropdown-item GmarketSansMedium"
									href="free-board.html">자유 게시판</a>
								<div class="dropdown-divider"></div>
								<h6 class="dropdown-header fw-normal GmarketSansMedium">고객센터</h6>
								<a class="dropdown-item GmarketSansMedium"
									href="knowledge-base.html">FAQ</a>
						...
						<li class="nav-item dropdown ps-2"><a
							...
							<div class="dropdown-menu dropdown-menu-end"
								...
								<a	class="dropdown-item GmarketSansMedium"
									href="user-profile-general.html">회원 정보</a>
								<div class="dropdown-divider"></div>
						...
						<li class="nav-item ps-2"><a
							class="nav-link TmoneyRoundWindExtraBold" href=""
							style="font-size: 1.2rem;">로그아웃</a></li>
					</ul>
				</div>
			</div>
		</nav>
					...
					<ul class="navbar-nav ms-auto">
						...
						<li class="nav-item dropdown ps-2"><a
							...
							<div class="dropdown-menu dropdown-menu-end"
								...
								<h6 class="dropdown-header fw-normal">계정</h6>
								<a class="dropdown-item GmarketSansMedium"
									href="user-profile-camping.html">캠핑장 회원 정보</a>
								<div class="dropdown-divider"></div>
								<h6 class="dropdown-header fw-normal">예약</h6>
								<a class="dropdown-item GmarketSansMedium"
