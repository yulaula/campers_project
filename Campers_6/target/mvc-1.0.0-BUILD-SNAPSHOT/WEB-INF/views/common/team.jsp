...
<section class="hero py-5 py-lg-7">
    ...
    <section class="py-6">
        <div class="container">
            ...
            <div class="row mb-7">
                <div class="mb-3 mb-lg-0 col-sm-6 col-lg-1-1">

                </div>
                <div class="mb-3 mb-lg-0 col-sm-6 col-lg-3">
                    <div class="card border-0 hover-animate bg-transparent">
                        <a class="position-relative" href="#"><img class="card-img-top team-img" src="img/newphoto/ironman.png" style="height: 350px;" alt="" />
                ...
                <div class="mb-3 mb-lg-0 col-sm-6 col-lg-3">
                    <div class="card border-0 hover-animate bg-transparent">
                        <a class="position-relative" href="#"><img class="card-img-top team-img" src="img/newphoto/goshim.png" style="height: 350px;" alt="" />
                            <div class="team-circle bg-info-light"></div>
                        </a>
                        <div class="card-body team-body text-center">
                ...
                <div class="mb-3 mb-lg-0 col-sm-6 col-lg-3">
                    <div class="card border-0 hover-animate bg-transparent">
                        <a class="position-relative" href="#"><img class="card-img-top team-img" src="img/newphoto/roopy.png" style="height: 350px;" alt="" />
                            <div class="team-circle bg-info-light"></div>
                        </a>
                        <div class="card-body team-body text-center">
                ...
                <div class="mb-3 mb-lg-0 col-sm-6 col-lg-3">
                    <div class="card border-0 hover-animate bg-transparent">
                        <a class="position-relative" href="#"><img class="card-img-top team-img" src="img/newphoto/chunbae.png" style="height: 350px;" alt="" />
                            <div class="team-circle bg-info-light"></div>
                        </a>
                        <div class="card-body team-body text-center">
                ...
                <div class="mb-3 mb-lg-0 col-sm-6 col-lg-3">
                    <div class="card border-0 hover-animate bg-transparent">
                        <a class="position-relative" href="#"><img class="card-img-top team-img" src="img/newphoto" style="height: 350px;" alt="" />
                            <div class="team-circle bg-info-light"></div>
                        </a>
                        <div class="card-body team-body text-center">
