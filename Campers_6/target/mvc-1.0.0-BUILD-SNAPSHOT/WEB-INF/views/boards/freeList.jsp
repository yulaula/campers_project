	...
	<div class="container">
		<div class="d-flex justify-content-between align-items-end mb-4 ms-3 row">
			<div class="row">
				...
				<div class="col-lg-8 d-flex align-items-end form-group no-divider ms-6 row">
					<form action="${ path }/boards/freeList" method="get" class="row align-items-end ps-6" style="margin-left: 5.5rem;">
						<div class="col-lg-4 d-flex align-items-end form-group no-divider GmarketSansMedium ps-5">
                        	...
                        	<select class="selectpicker form-control " title="전체 " data-style="btn-form-control" style="border: 1px solid #ced4da; ">
                         	   <option  name="searchType"  value="writer">작성자</option>
                            	<option  name="searchType"  value="title">제목</option>
                            	<option   name="searchType" value="content">내용</option>
                        	</select>
                        	-->
						</div>
						<div class="col-lg-4 input-label-absolute input-label-absolute-left mt-5" style="width: 40%;">
						...
						<!-- 로그인 완성되면 열것!!! ★★★★★ -->
						<!-- 로그인 상태일 때만 글쓰기 가능함 -->
						<!-- 버튼은 살아있고 로그인 여부 따진 뒤 로그인X : MSG 로그인이 필요합니다. 뜨게 -->
			...
			<div class="list-group-item list-group-item-action py-0">
				<div class="row">
					...
					<div class="col-1 col-lg-1 py-3 ps-5">
						<div class="form-post d-none d-sm-block mt-n1 ps-sm-5-1 text-end">
							<p class="text-sm text-end">No.</p>
						</div>
					</div>
					-->
