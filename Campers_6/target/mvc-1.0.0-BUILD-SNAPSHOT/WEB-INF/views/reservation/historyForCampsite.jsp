...
<jsp:include page="/WEB-INF/views/common/header.jsp">
	<jsp:param value="예약내역 | 캠핑장" name="title"/>
</jsp:include>
...
<section class="py-5">
        <div class="container">
            ...
            <ol class="breadcrumb ps-0  justify-content-start">
                ...
                <li class="breadcrumb-item active">호스트 페이지 </li>
            </ol>
            <div class="d-flex justify-content-between align-items-end mb-5">
                <h1 class="hero-heading mb-0">내 캠핑장 예약 내역</h1><a class="btn btn-link text-muted" href="apps-calendar.html">달력으로 확인하기</a>
            </div>
            <div class="d-flex justify-content-between align-items-center flex-column flex-lg-row mb-5">
                <div class="me-3">
                    <!-- strong 태그 안에 예약내역 개수 불러오기-->
                    <p class="mb-3 mb-lg-0">내 캠핑장에 <strong>12 </strong> 개의 예약이 있어요!</p>
                </div>
