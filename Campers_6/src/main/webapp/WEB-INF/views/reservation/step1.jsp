            ...
            <div class="row">
                <div class="col-lg-7">
                    ...
                    <div class="row form-block flex-column flex-sm-row">
                        ...
                        <div class="col text-center text-sm-end"><a class="btn btn-primary px-3" href="${path}/reservation/step2"> Next step<i class="fa-chevron-right fa ms-2"></i></a></div>
                    </div>
                </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-block pt-3 pb-0">
                                <table class="w-100">
                                    <tbody>
                                        <tr>
                                            <th class="fw-normal py-2">${campsite.cost} x 1 박</th>
