			...
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<a href="${path}/resources/img/newphoto/login_image2.png"
						...
						class="img-fluid"
						src="${path}/resources/img/newphoto/login_image2.png"
						alt="Outside"></a>
				</div>
			</div>
				...
				<div class="text-block">
					...
					<div class="d-flex d-block d-sm-flex review">
						<div>
							...
							<span class="text-uppercase text-muted text-sm">2022년 2월
								9일</span>
						</div>
					</div>
					<div class="d-flex d-block d-sm-flex review">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="mb-4">
											...
											<select class="form-select focus-shadow-0" name="rating"
												id="rating">
												<option value="5">&#9733;&#9733;&#9733;&#9733;&#9733;
													(5/5)</option>
												<option value="4">&#9733;&#9733;&#9733;&#9733;&#9734;
			...
			<div class="col-lg-4">
				<div class="p-4 shadow ms-lg-4 rounded sticky-top"
					...
					<form class="form" id="booking-form" method="get" action="#" autocomplete="off">
						...
						<form action ="${path}/reservation/step1" method ="GET" name="headCount" id="headCount">
						<div class="mb-4">
						...
						<c:when test="${loginuser != null }">
							<a class="btn btn-primary" href="${path}/reservation/step1?campsite_index=${campsite.campsite_index}">예약하기</a>
						</c:when>
						<c:otherwise>
							<a class="btn btn-primary" href="${path}/reservation/step1?campsite_index=${campsite.campsite_index}" disabled>예약하기</a>
						</c:otherwise>
						</c:choose>
						</div>
